...
<xsl:stylesheet version="1.0" 
                ...
                xmlns:drawooo="http://openoffice.org/2009/draw" 
                ...
                exclude-result-prefixes="chart config dc dom dr3d draw drawooo fo form manifest math meta number office officeooo ooo script style svg table text xforms xlink xsd xsi xsl xalan">
